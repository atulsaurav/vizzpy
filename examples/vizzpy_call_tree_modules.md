...
flowchart LR
    ...
    subgraph __ext__["external libraries"]
        ...
        subgraph fastapi["fastapi"]
            ...
            fastapi__staticfiles_["fastapi.staticfiles"]
        end
    end
    ...
    vizzpy__server_ -->|"3x"| fastapi__responses_
    vizzpy__server_ --> fastapi__staticfiles_
    vizzpy__server_ --> logging_
    vizzpy__server_ -->|"2x"| pathlib_
    ...
    class argparse_,ast_,collections_,fastapi_,fastapi__responses_,fastapi__staticfiles_,graphviz_,logging_,pathlib_,sys_,tarfile_,tempfile_,uvicorn_,zipfile_ external
```
